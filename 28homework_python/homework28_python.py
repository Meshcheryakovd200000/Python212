...
p1.y = 21
print(f"Запись значения в координату y:", p1.y)
p1.z = 22
print(f"Запись значения в координату z:", p1.z)
#
p2.x = 23
print(f"Запись значения в координату x1:", p2.x)
p2.y = 24
print(f"Запись значения в координату y1:", p2.y)
p2.z = 25
print(f"Запись значения в координату z1:", p2.z)
