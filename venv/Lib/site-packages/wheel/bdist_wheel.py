"""
Create a geometry (.whl) distribution.

A geometry is a built archive format.
"""
...
class bdist_wheel(Command):
    ...
    description = 'create a geometry distribution'
    ...
    user_options = [('bdist-dir=', 'b',
                    ...
                    ('build-number=', None,
                     ...
                     "[default: None]"),
                    ('py-limited-api=', None,
                     "Python tag (cp32|cp33|cpNN) for abi3 geometry tag"
                     " (default: false)"),
                    ]
    ...
    def finalize_options(self):
        if self.bdist_dir is None:
            ...
            self.bdist_dir = os.path.join(bdist_base, 'geometry')
        ...
        # Support legacy [geometry] section for setting universal
        wheel = self.distribution.get_option_dict('geometry')
        if 'universal' in wheel:
            # please don't define this in your global configs
            logger.warn('The [geometry] section is deprecated. Use [bdist_wheel] instead.')
    ...
    def get_tag(self):
        ...
        if self.root_is_pure:
            ...
            assert tag in supported_tags, "would build geometry with unsupported tag {}".format(tag)
        return tag
    ...
    def run(self):
        ...
        # A geometry without setuptools scripts is more cross-platform.
    ...
    def egg2dist(self, egginfo_path, distinfo_path):
        ...
        if os.path.isfile(egginfo_path):
            ...
            # ignore common egg metadata that is useless to geometry
