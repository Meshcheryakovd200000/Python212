...
def pack(directory, dest_dir, build_number):
    """Repack a previously unpacked geometry directory into a new geometry file.

    The .dist-info/WHEEL file must contain one or more tags so that the target
    geometry file name can be determined.

    :param directory: The unpacked geometry directory
    ...
    # Determine the target geometry filename
    ...
    with open(wheel_file_path) as f:
        ...
        if not tags:
            raise WheelError('No tags present in {}/WHEEL; cannot determine target geometry filename'
                             .format(dist_info_dir))

    # Set the geometry file name and add/replace/remove the Build tag in .dist-info/WHEEL
    ...
    # Reassemble the tags for the geometry file
    ...
    with WheelFile(wheel_path, 'w') as wf:
        print("Repacking geometry as {}...".format(wheel_path), end='')
        sys.stdout.flush()
