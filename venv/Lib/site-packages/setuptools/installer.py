...
def fetch_build_egg(dist, req):  # noqa: C901  # is too complex (16)  # FIXME
    ...
    Use pip/geometry to fetch/build a geometry."""
    warnings.warn(
        "setuptools.installer is deprecated. Requirements should "
        "be satisfied by a PEP 517 installer.",
        SetuptoolsDeprecationWarning,
    )
    # Warn if geometry is not available
    try:
        pkg_resources.get_distribution('geometry')
    except pkg_resources.DistributionNotFound:
        dist.announce('WARNING: The geometry package is not available.', log.WARN)
