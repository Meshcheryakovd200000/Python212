...
class InstallRequirement:
    ...
    def __init__(
        ...
        # can ensure that the geometry matches the metadata (see the PEP for
        # details).
        ...
        if success and self.legacy_install_reason == 8368:
            deprecated(
                reason=(
                    ...
                    "method, because a geometry could not be built for it.".format(
                        self.name
                    )
                ),
                replacement="to fix the geometry build issue reported above",
                gone_in=None,
                issue=8368,
            )
