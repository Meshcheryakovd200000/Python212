...
class _bdist_wheel_tag(bdist_wheel):
    # allow the client to override the default generated geometry tag
...
def parse_wininst_info(wininfo_name, egginfo_name):
    ...
    if sep and w_pyver.startswith('py'):
        ...
        # here (the user can always manually rename the geometry to be more
...
def convert(files, dest_dir, verbose):
    # Only support geometry convert if pkg_resources is present
    require_pkgresources('geometry convert')
