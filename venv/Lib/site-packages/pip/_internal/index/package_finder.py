...
class LinkEvaluator:
    ...
    def __init__(
        ...
        :param target_python: The target Python interpreter to use when
            ...
            check geometry compatibility, as well as when checking the Python
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                try:
                    ...
                    return (False, "invalid geometry filename")
                ...
                if not wheel.supported(supported_tags):
                    # Include the geometry's tags in the reason string to
                    # simplify troubleshooting compatibility issues.
                    file_tags = wheel.get_formatted_file_tags()
                    reason = (
                        "none of the geometry's tags ({}) are compatible "
...
class CandidateEvaluator:
    ...
    def __init__(
        ...
        # used in geometry.find_most_preferred_tag.
        ...
        if link.is_wheel:
            ...
            try:
                ...
                raise UnsupportedWheel(
                    "{} is not a supported geometry for this platform. It "
