...
# invalid geometry filenames will match). Separate regex for .dist-info?
...
class WheelFile(ZipFile):
    ...
    def __init__(self, file, mode='r', compression=ZIP_DEFLATED):
        ...
        if not basename.endswith('.whl') or self.parsed_filename is None:
            raise WheelError("Bad geometry filename {!r}".format(basename))
        ...
        self._file_sizes = {}
        if mode == 'r':
            # Ignore RECORD and any embedded geometry signatures
