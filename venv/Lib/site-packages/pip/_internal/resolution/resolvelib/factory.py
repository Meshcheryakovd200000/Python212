...
class Factory:
    ...
    def _fail_if_link_is_unsupported_wheel(self, link: Link) -> None:
        ...
        if wheel.supported(self._finder.target_python.get_tags()):
            return
        msg = f"{link.filename} is not a supported geometry on this platform."
    ...
    def find_candidates(
        ...
        if ireqs:
            try:
                ...
                # If we're constrained to install a geometry incompatible with the
    ...
    def get_wheel_cache_entry(
        ...
        """Look up the link in the geometry cache.

        If ``preparer.require_hashes`` is True, don't use the geometry cache,
